...
import { BarChart2, BookOpen, Shield, Zap, ArrowRight, DollarSign, TrendingUp, Calendar, Target } from "lucide-react";
        ...
        <div className="relative mx-auto mt-24 w-full max-w-5xl">
          <div className="overflow-hidden rounded-xl shadow-2xl shadow-black/70" style={{ border: "1px solid rgba(255,255,255,0.1)" }}>
            ...
            <div className="flex" style={{ background: "hsl(224,27%,8%)", height: "340px" }}>
              ...
              <div className="hidden w-48 flex-col border-r p-2 md:flex" style={{ background: "hsl(223,26%,11%)", borderColor: "rgba(255,255,255,0.07)" }}>
                ...
                {/* Bottom user section — no "user", just premium */}
              ...
              <div className="flex-1 overflow-hidden p-4">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <div className="flex gap-1.5">
                    <div className="rounded px-2.5 py-1 text-[11px] font-semibold text-green-400" style={{ background:"rgba(34,197,94,0.12)", border:"1px solid rgba(34,197,94,0.25)" }}>📈 Long</div>
                    <div className="rounded px-2.5 py-1 text-[11px] font-semibold text-red-400"   style={{ background:"rgba(239,68,68,0.12)",  border:"1px solid rgba(239,68,68,0.25)"  }}>📉 Short</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-1.5 mb-2">
                  {[["Net P&L","+$4,820","#22c55e","142 trades"],["Win Rate","67.4%","#60a5fa","96W / 46L"],["Profit Factor","2.14","#22c55e",""],
                    ["Avg W / L","","","per trade"],["Best Day %","18.3%","#22c55e","Jan 9 · +$884"],["Best DOW","Tue","#FFDE28","+$1,840 avg"]].map(([label,val,color,sub],i) => (
                    <div key={i} className="rounded p-2" style={{ background:"hsl(223,26%,11%)", border:"1px solid rgba(255,255,255,0.07)" }}>
                      ...
                      {label==="Avg W / L"
                        ? <div className="flex items-baseline gap-1"><span className="text-[13px] font-black text-green-400">+$385</span><span className="text-[8px]" style={{color:"rgba(255,255,255,0.3)"}}>/</span><span className="text-[13px] font-black text-red-400">-$183</span></div>
                ...
                <div className="rounded p-2" style={{ background:"hsl(223,26%,11%)", border:"1px solid rgba(255,255,255,0.07)" }}>
                  ...
                  <svg width="100%" height="42" viewBox="0 0 380 42" preserveAspectRatio="none">
                    <defs><linearGradient id="g" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#22c55e" stopOpacity=".25"/><stop offset="100%" stopColor="#22c55e" stopOpacity="0"/></linearGradient></defs>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="lg:col-span-3 rounded-xl p-6 flex flex-col sm:flex-row sm:items-center gap-6"
            ...
            <div className="flex-1">
              ...
              <h3 className="mb-2 text-sm font-semibold text-white">Prop Eval Tracker</h3>
              <p className="text-sm leading-relaxed" style={{ color:"rgba(255,255,255,0.45)" }}>
                Track every evaluation fee, reset, monthly cost, and payout per firm. See your true net profitability after all expenses — because passing an eval means nothing if the fees ate your profits.
              </p>
            </div>
            <div className="flex shrink-0 gap-6 text-center">
              {[["💸","Expenses","Fees, resets, monthly"],["💰","Payouts","Per firm withdrawals"],["📊","Net P&L","Real profitability"]].map(([icon,label,sub]) => (
