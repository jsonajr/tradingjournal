...
const STEPS = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Click + Add Account",
      "Enter a name (e.g. "Apex 150K"), your firm, and starting balance",
      "Create separate accounts for each prop firm evaluation",
    ],
    tip: "Pro tip: name accounts clearly — 'Apex 150K #2' is better than 'Account 1'.",
  },
  {
    num: "03",
  ...
  },
  {
    ...
    steps: [
      ...
      "Track multiple firms separately to see which ones are actually worth it",
    ],
