...
export default async function NewTradePage() {
  ...
  const [{ data: accounts }, { data: settings }, { data: mistakes }] = await Promise.all([
  ...
  return <NewTradeClient accounts={accounts ?? []} autoCommission={settings?.auto_commission ?? null} mistakes={mistakes ?? []} />;
}